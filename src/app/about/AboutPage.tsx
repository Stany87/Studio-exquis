  ...
  return (
    <div ref={pageRef} style={{ background: "transparent" }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div data-reveal className="reveal-fade text-center mb-16">
            <span className={`text-[10px] tracking-[0.3em] uppercase block mb-4 ${gfsDidot.className}`} style={{ color: SE.textMuted }}>OUR BEGINNING</span>
            <h2 className={`${greatVibes.className}`} style={{ color: SE.text, fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div data-reveal className="reveal-fade text-center mb-16">
            <span className={`text-[10px] tracking-[0.3em] uppercase block mb-4 ${gfsDidot.className}`} style={{ color: SE.textMuted }}>MEET OUR FOUNDER</span>
            <h2 className={`${greatVibes.className}`} style={{ color: SE.text, fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div data-reveal className="reveal-fade text-center mb-16">
            <span className={`text-[10px] tracking-[0.3em] uppercase block mb-4 ${gfsDidot.className}`} style={{ color: SE.textMuted }}>OUR PHILOSOPHY</span>
            <h2 className={`${greatVibes.className}`} style={{ color: SE.text, fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div data-reveal className="reveal-fade text-center mb-20">
            <span className={`text-[10px] tracking-[0.3em] uppercase block mb-4 ${gfsDidot.className}`} style={{ color: SE.textMuted }}>THE JOURNEY</span>
            <h2 className={`${greatVibes.className}`} style={{ color: SE.text, fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div data-reveal className="reveal-fade text-center mb-16">
            <span className={`text-[10px] tracking-[0.3em] uppercase block mb-4 ${gfsDidot.className}`} style={{ color: SE.accent }}>BY THE NUMBERS</span>
            <h2 className={`${greatVibes.className}`} style={{ color: "rgba(255,255,255,0.9)", fontSize: "clamp(2.2rem, 5vw, 3.5rem)" }}>
      ...
      >
        <div data-reveal className="reveal-fade text-center mb-12">
          <span className={`text-[10px] tracking-[0.3em] uppercase block mb-4 ${gfsDidot.className}`} style={{ color: SE.textMuted }}>SELECTED WORK</span>
          <h2 className={`${greatVibes.className}`} style={{ color: SE.text, fontSize: "clamp(2rem, 4vw, 3rem)" }}>
      ...
      >
        <div data-reveal className="reveal-fade max-w-2xl mx-auto">
          <span className={`text-[10px] tracking-[0.3em] uppercase block mb-6 ${gfsDidot.className}`} style={{ color: SE.textMuted }}>READY TO BEGIN?</span>
          <h2 className={`${greatVibes.className} mb-6`} style={{ color: SE.text, fontSize: "clamp(2.5rem, 6vw, 4.5rem)", lineHeight: 1.2 }}>
